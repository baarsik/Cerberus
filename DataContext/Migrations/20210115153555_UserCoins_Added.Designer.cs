...
namespace DataContext.Migrations
{
    ...
    [Migration("20210115153555_UserCoins_Added")]
    partial class UserCoins_Added
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DataContext.Models.ApplicationUser", b =>
                {
                    ...
                    b.Property<DateTime?>("ReadOnlyEnd")
            ...
            modelBuilder.Entity("DataContext.Models.ApplicationUserCoinUpdate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("ApplicationUserCoinUpdate");
                });
            ...
            modelBuilder.Entity("DataContext.Models.Comment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DataContext.Models.WebNovelChapterContentReaderData", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("WebNovelChapterContentReaderData");
                });
            ...
            modelBuilder.Entity("DataContext.Models.WebNovelChapterContentReaderData", b =>
                {
                    b.HasOne("DataContext.Models.WebNovelChapterContent", "ChapterContent")
                        .WithMany("ReaderData")
                    ...
                    b.HasOne("DataContext.Models.ApplicationUser", "User")
                        .WithMany("WebNovelChapterContentReaderData")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("DataContext.Models.ApplicationUser", b =>
                {
                    ...
                    b.Navigation("WebNovelChapterContentReaderData");
